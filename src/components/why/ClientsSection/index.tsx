    ...
    <section ref={ref} className={styles.section}>
      <div className={styles.inner}>
        <div className={`${styles.header} ${isVisible ? styles.visible : ''}`}>
          ...
          <h2 className={styles.title}>Built for Organizations That Demand Excellence</h2>
          <p className={styles.subtitle}>
            From nimble startups to large enterprises and government agencies,
            we adapt our approach to match your scale, governance, and goals.
          </p>
        </div>
